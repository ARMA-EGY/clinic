        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            ...
            <div class="col-lg-6 col-5 text-right">
              <a href="{{ route('expensescategory.create')}}" class="btn btn-sm btn-neutral"><i class="fa fa-plus"></i> {{__('master.ADD-NEW-CATEGORY')}}</a>
            </div>
              ...
              <table class="table align-items-center table-flush display nowrap" id="example">
                ...
                <tbody>
                  ...
                  <tr class="parent">
                    ...
                    <td><b> {{  $item->name }} </b></td>
                    <td>
                      <a href="{{ route('expensescategory.edit', $item->id)}}" class="btn btn-primary btn-sm mx-1"> <i class="fa fa-edit"></i> {{__('master.EDIT')}} </a>
                    </td>
                  </tr>
