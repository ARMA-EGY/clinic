            ...
            <div class="col-lg-6 col-7 {{$text}}">
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">{{__('admin.ALL-DOCTORS')}}</li>
                </ol>
              </nav>
            </div>

            <div class="col-lg-6 col-5 {{$inverse_text}}">
              <a href="{{ route('doctors.create')}}" class="btn btn-sm btn-neutral"><i class="fa fa-plus"></i> {{__('admin.ADD-NEW-DOCTOR')}}</a>
            </div>
          ...
          <div class="card">
            <div class="card-header border-0">
              <div class="row align-items-center">
                <div class="col">
                  <h3 class="mb-0">{{__('admin.ALL-DOCTORS')}} <span class="badge badge-primary p-2">{{$total_rows}}</span></h3>
                </div>
              </div>
            </div>
              ...
              <table class="table align-items-center table-flush display nowrap" id="example">
                ...
                <tbody>
                  ...
                  <tr class="parent">
                    ...
                    <td>
                      <a href="{{ route('doctors.edit', $item->id)}}" class="btn btn-primary btn-sm mx-1"> <i class="fa fa-edit"></i> {{__('admin.EDIT')}} </a>
                    </td>
                  </tr>
