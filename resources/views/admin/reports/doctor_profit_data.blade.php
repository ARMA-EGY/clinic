                ...
                <p class="mt-3 mb-0 text-sm">
                  <span class="text-nowrap text-success">
                    @if ($transactions->count() > 0)
                     {{$transactions->sum('total') * $doctor->profit_ratio / 100}} <i class="fa fa-dollar-sign"></i>
                    @endif
                  </span>
                </p>
              </div>
                    ...
                    <table class="table align-items-center table-flush display nowrap" id="example2">
                      <thead class="thead-light">
                        <tr>
                          ...
                          <th scope="col" class="sort" >{{__('master.PROFIT-RATIO')}}</th>
                          <th scope="col" class="sort" >{{__('master.DOCTOR-PROFIT')}}</th>
                        </tr>
                      </thead>
                      <tbody>
                        ...
                        <tr class="parent">
                          ...
                          <td>{{ $doctor->profit_ratio }} %</td>
                          <td>{{ $transaction->total * $doctor->profit_ratio / 100 }} </td>
                        </tr>
                      ...
                      <tfoot>
                          <tr>
                              ...
                              <th scope="col" class="sort p-2" >{{__('master.PROFIT-RATIO')}}</th>
                              <th scope="col" class="sort p-2" >{{__('master.DOCTOR-PROFIT')}}</th>
                          </tr>
                      </tfoot>
                    </table>
                  </div>
