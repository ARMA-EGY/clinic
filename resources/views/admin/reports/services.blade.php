            ...
            <div class="col-lg-12 col-12 text-left">
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">{{__('master.SERVICES')}}</li>
                </ol>
              </nav>
            </div>
          ...
          <div class="card">
            <div class="card-header border-0">
              <div class="row align-items-center">
                <div class="col">
                  <h3 class="mb-0">{{__('master.SERVICES')}} <span class="badge badge-primary p-2">{{$total_rows}}</span></h3>
                </div>
              </div>
            </div>
              ...
              <table class="table align-items-center table-flush display nowrap" id="example">
                ...
                <tfoot>
                    <tr>
                        ...
                        <th scope="col" class="sort p-2" >{{__('master.SERVICE-NUMBER')}}</th>
      ...
      $('#example tfoot th').each( function () {
         ...
         var table = $('#example').DataTable({
            ...
            buttons: [
                        ...
                        { extend: 'excel', title: 'Services Report', className: 'btn btn-sm btn-success' },
                        { extend: 'print', text: '{{__("master.PRINT")}}', title: 'Services Report', className: 'btn btn-sm btn-primary' },
                    ]
         });
