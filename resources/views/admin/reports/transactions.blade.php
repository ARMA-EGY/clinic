          ...
          <div class="card">
            <div class="card-header border-0">
              <div class="row align-items-center">
                <div class="col">
                  <h3 class="mb-0">{{__('master.TRANSACTIONS')}} <span class="badge badge-primary p-2">{{$total_rows}}</span></h3>
                </div>
              </div>
            </div>
              ...
              <table class="table align-items-center table-flush display nowrap" id="example">
                ...
                <tbody>
                  ...
                  <tr class="parent">
                    ...
                    <td><strong>{{ $item->tax_percentage }} %</strong></td>
                    <td><strong>{{ $item->total }}</strong> </td>
                    <td><strong>{{__('master.'.$item->payment_method)}}</strong></td>
                  </tr>
