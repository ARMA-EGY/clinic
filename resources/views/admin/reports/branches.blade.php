        ...
        <div class="header-body">
            ...
            <div class="col-lg-12 col-12 text-left">
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">{{__('master.BRANCHES')}}</li>
                </ol>
              </nav>
            </div>
          ...
          <div class="row justify-content-center pb-4">
              ...
              <div class="form-group col-md-3 mb-2 text-left">
                  <label class="font-weight-bold text-uppercase text-white" >{{__('master.BRANCHES')}}</label>
                      <select name="branch_id" id="branch_id" class="form-control form-control-sm">
                        <option value="0">{{__('master.ALL-BRANCHES')}}</option>
